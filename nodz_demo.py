...
def test():
    ...
    @QtCore.Slot(str)
    def on_nodeRightClick(nodeName):
        print 'right click on node : {0}'.format(nodeName)
    ...
    # nodz.signal_NodeRightClicked.connect(on_nodeRightClick)
    ...
    # Node A
    nodeA = nodz.createNode(name='nodeA', preset='node_default', position=None)
    ...
    # Node B
    nodeB = nodz.createNode(name='nodeB', preset='node_default')
    ...
    # Node C
    nodeC = nodz.createNode(name='nodeC', preset='node_default')
